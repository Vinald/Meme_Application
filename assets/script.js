...
const btnMeme = document.querySelector("#btnMeme");
...
const showJoke = () => {
    ...
    console.log("Random Joke Text:", randomJokeText); // Debugging line

    const jokeContainer = document.querySelector(".joke-content");
    console.log("Joke Container:", jokeContainer); // Debugging line
    ...
    if (jokeContainer) {
        ...
        console.log("New Joke added to DOM"); // Debugging line
    } else {
        console.error("Joke container not found in the DOM");
    }
};

const btnJoke = document.querySelector("#btnJoke");
console.log("Button Joke:", btnJoke); // Debugging line
...
const showQuote = () => {
    ...
    newQuote.textContent = randomQuoteText.quote;
    newQuoteAuthor.textContent = `- ${randomQuoteText.author}`;

    // Add the new quote to the document
...
const btnRiddle = document.querySelector("#btnRiddle");
btnRiddle.addEventListener("click", () => {
    clearAll();
    showRiddle();
});

// Function: Show Riddle Answer
const revealAnswers = () => {
...
const btnShowRiddleAnswer = document.getElementById("show-riddle-answer");
btnShowRiddleAnswer.addEventListener("click", () => {
    revealAnswers();
});
